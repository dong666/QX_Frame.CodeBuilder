...
namespace CSharp_FlowchartToCode_DG.CodeCreate
{
    public class QX_FrameToDataService
    {
        public static string CreateCode(Dictionary<string, dynamic> CreateCodeDic)
        {
            ...
            str.Append("\t" + "{" + "\r\n");
            //add private member
            str.Append("\t\t" + $"private {ClassName} _{ClassName};" + "\r\n");
            //添加构造方法
            str.Append("\t\t" + "/// <summary>" + "\r\n");
            ...
            str.Append("\t\t" + "{}" + "\r\n" + "\r\n");
            //add method
            str.Append("\t\t" + "public " + ClassName + ClassNamePlus + $"({ClassName} {ClassName})" + "\r\n");
            str.Append("\t\t" + "{" + "\r\n");
            str.Append("\t\t\t" + $"this._{ClassName} = {ClassName};" + "\r\n");
            str.Append("\t\t" + "}" + "\r\n");

            str.Append("\t\t" + $"public bool Add({ClassName} {ClassName})" + "\r\n");
            str.Append("\t\t" + "{" + "\r\n");
            str.Append("\t\t\t" + $"return {ClassName}.Add();" + "\r\n");
            str.Append("\t\t" + "}" + "\r\n");

            str.Append("\t\t" + $"public bool Update({ClassName} {ClassName})" + "\r\n");
            str.Append("\t\t" + "{" + "\r\n");
            str.Append("\t\t\t" + $"return {ClassName}.Update();" + "\r\n");
            str.Append("\t\t" + "}" + "\r\n");

            str.Append("\t\t" + $"public bool Delete({ClassName} {ClassName})" + "\r\n");
            str.Append("\t\t" + "{" + "\r\n");
            str.Append("\t\t\t" + $"return {ClassName}.Delete();" + "\r\n");
            str.Append("\t\t" + "}" + "\r\n");
